...
LOGGING = {
    ...
    "loggers": {
        ...
        # App loggers propagate to root rather than declaring their own
        # handler, so every app can log with getLogger(__name__) and land
        # in the same place without repeating handler/formatter config.
    },
}
